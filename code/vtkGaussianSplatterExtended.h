/*=========================================================================
  ...
  Module:    vtkGaussianSplatterExtended.h
...
=========================================================================*/
// .NAME vtkGaussianSplatterExtended - splat points into a volume with an elliptical, Gaussian distribution
// .SECTION Description
// vtkGaussianSplatterExtended is a filter that injects input points into a
...
#ifndef __vtkGaussianSplatterExtended_h
#define __vtkGaussianSplatterExtended_h
...
{
public:
  vtkTypeMacro(vtkGaussianSplatterExtended,vtkImageAlgorithm);
  ...
  static vtkGaussianSplatterExtended *New();
...
private:
  double Radius2;
  double (vtkGaussianSplatterExtended::*Sample)(double x[3]);
  double (vtkGaussianSplatterExtended::*SampleFactor)(double s);
  char *Visited;
...
private:
  vtkGaussianSplatterExtended(const vtkGaussianSplatterExtended&);  // Not implemented.
  void operator=(const vtkGaussianSplatterExtended&);  // Not implemented.
};
